...
export function achievementIconUrl(category: AchievementCategory, locked = false): string {
  return locked ? ICONS.locked : ICONS[CATEGORY_ICON[category]];
}

export function achievementIconMarkup(category: AchievementCategory, locked = false, className = 'achievement-icon'): string {
