...
const checks = [
  ...
  [
    "autoClicker",
    migrated.upgrades.autoClicker === oldSave.upgrades.autoClicker,
  ],
  ["achievement", migrated.unlockedAchievements.includes("CLICK_10")],
  [
    "deep defaults",
    migrated.deepPrestige.level === 0 && migrated.deepPrestige.shards === 0,
  ],
  [
    "season defaults",
    typeof migrated.season.id === "string" && migrated.season.id.length > 0,
  ],
  [
    "background defaults",
    migrated.background.mode === "default" &&
      migrated.background.preset === "neonGrid",
  ],
