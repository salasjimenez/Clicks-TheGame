...
export class GameEngine {
    ...
    get derived() {
        ...
        const offlineEfficiency = Math.min(0.8, 0.35 + this.state.upgrades.offlineBattery * 0.05 + this.state.deepPrestige.upgrades.timeDilation * 0.03);
        ...
        const criticalChance = Math.min(0.65, 0.05 + this.state.upgrades.luckyChip * 0.02 + this.state.deepPrestige.upgrades.criticalMatrix * 0.01 + criticalEvent);
